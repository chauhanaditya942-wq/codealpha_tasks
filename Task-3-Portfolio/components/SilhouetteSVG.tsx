export default function SilhouetteSVG() {
  return (
    <div className="relative w-full max-w-[420px] aspect-[3/4] rounded-[160px_160px_0_0] overflow-hidden bg-slate-900 dark:bg-black self-end">
      ...
      {[
        ...
        <span
          ...
          style={{
            ...
            width: p.size,
            height: p.size,
            animation: `twinkle 3s ease-in-out ${p.delay} infinite`,
          }}
        />
      ))}
      ...
      >
        <ellipse cx="150" cy="200" rx="110" ry="160" fill="rgba(255,255,255,0.03)" />
        {/* Body */}
      ...
      <div className="absolute bottom-8 -left-5 w-[110px] h-[110px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            className="w-11 h-11 rounded-full bg-white flex items-center justify-center text-slate-900 text-[9px] font-black text-center leading-tight"
